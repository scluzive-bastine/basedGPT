    ...
    <div className='App'>
      <section className='h-[400px] lg:min-h-[652px] bg-gradient-to-b from-[#641F27] to-[#121212] relative overflow-hidden'>
        <div className=''>
          ...
          <div className='px-4 absolute md:right-20 bottom-12 md:max-w-sm md:text-right'>
      ...
      <div className='pt-20 px-4 lg:px-20 pb-40 relative z-10 bg-gradient-to-b from-[#121212]'>
        <div className='grid grid-cols-12 gap-8 items-center border-b border-gray-300 border-dashed pb-10 '>
          <div className='col-span-12 md:col-span-8'>
            <div className=' text-white text-2xl lg:text-3xl 2xl:text-5xl lg:!leading-[50px] 2xl:!leading-[60px]'>
              <Fade left>
                BasedGPT is a Arbitrum Layer-2 that lets you generate any form of AI prompt and
                share reward from revenue generated by the BasedAI
              </Fade>
            </div>
        ...
        <div className='max-w-screen-2xl mx-auto'>
          <div className='grid grid-cols-12 gap-4'>
            <div className='col-span-12 lg:col-span-3'>
              <div className='rounded-2xl border border-gray-300 p-5 lg:p-10 2xl:p-16 h-full'>
            ...
            <div className='col-span-12 lg:col-span-9'>
              ...
              <div className='rounded-2xl border border-gray-300 p-5 lg:p-10 2xl:p-16 mt-4'>
      ...
      <section className='px-4 lg:px-16 2xl:px-32 pb-40'>
        ...
        <div className='grid grid-cols-12 gap-8 mt-10 '>
          <div className='col-span-12 md:col-span-6 lg:col-span-5 '>
            <div className="rounded-2xl p-5 h-full lg:p-10 bg-red-1000 bg-[url('./assets/bg-b1.png')] bg-cover bg-center bg-no-repeat lg:min-h-[450px] flex flex-col justify-between">
              <div>
          ...
          <div className='col-span-12 md:col-span-6 lg:col-span-7 '>
            <div className="rounded-2xl p-5 h-full lg:p-10 bg-red-1000 bg-[url('./assets/bg-p1.png')] bg-cover bg-center bg-no-repeat lg:min-h-[450px] flex flex-col justify-between">
              <div>
                <h2 className='text-lg lg:text-xl font-semibold text-gray-200 uppercase font-sulphur'>
                  Reward System
                </h2>
        ...
        <div className='grid grid-cols-12 gap-8 mt-10 '>
          ...
          <div className='col-span-12 md:col-span-6 lg:col-span-5 '>
            <div className="rounded-2xl p-5 h-full lg:p-10 bg-black bg-[url('./assets/bg-b2.png')] bg-cover bg-center bg-no-repeat lg:min-h-[450px] flex flex-col justify-between">
              <div>
                <h2 className='text-lg lg:text-xl font-semibold text-gray-200 uppercase font-sulphur'>
                  Security
                </h2>
        ...
        <div className='grid grid-cols-12 mt-10'>
          <div className='col-span-12 lg:col-span-12'>
            <div className='rounded-2xl p-5 lg:p-10 bg-black bg-cover bg-center bg-no-repeat max-h-[450px] flex flex-col justify-between'>
              <div>
                <h2 className='text-lg lg:text-xl font-semibold text-gray-200 uppercase font-sulphur'>
                  Governance
                </h2>
