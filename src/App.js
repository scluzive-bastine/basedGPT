        ...
        <div className=''>
          ...
          >
            ...
            <p className='mt-2 text-gray-300 lg:text-xl'>
              Eco AI content creation project. It allows users to use their EGPT token to buy
      ...
      <div className='pt-20 px-4 lg:px-20 pb-40 relative z-10 bg-gradient-to-b from-[#121212]'>
        <div className='grid grid-cols-12 gap-8 items-center border-b border-gray-300 border-dashed pb-10 '>
          <div className='col-span-12 md:col-span-8'>
            ...
            >
              EcoGPT is a Arbitrum Layer-2 that lets you generate any form of AI prompt and share
              reward from revenue generated by the EcoAI
            </div>
              ...
              <div className='col-span-12 md:col-span-5 xl:p-5'>
                ...
                >
                  ...
                  <p className='mt-10 text-xl text-gray-200'>
                    With EcoGPT, it is now easier than ever to edit AI text quickly and
            ...
            <div className='grid grid-cols-12 gap-8 mt-10 items-start'>
              <div className='col-span-12 md:col-span-5 xl:p-5'>
                ...
                >
                  ...
                  <p className='mt-10 text-xl text-gray-200'>
                    EcoGPT provides an efficient way to export project results in both PDF and
          ...
          <div className='col-span-12 md:col-span-6 lg:col-span-7 '>
            ...
            >
              <div>
                ...
                <p className='mt-4 text-white text-xl lg:text-3xl'>
                  EcoGPT has a reward system for token holders who contribute to the platform.
          ...
          <div className='col-span-12 md:col-span-6 lg:col-span-5 '>
            ...
            >
              <div>
                ...
                <p className='mt-4 text-white text-xl lg:text-3xl'>
                  EcoGPT utilizes blockchain technology to ensure the security of the platform.
